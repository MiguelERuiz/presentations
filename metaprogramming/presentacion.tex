...
\begin{frame}{Metaprogramación en Elixir}{¿Cómo?}
  ...
  \end{block}
  \footnotetext[2]{\href{https://hexdocs.pm/elixir/1.16/syntax-reference.html\#reserved-words}{https://hexdocs.pm/elixir/1.16/syntax-reference.html\#reserved-words}}
\end{frame}
